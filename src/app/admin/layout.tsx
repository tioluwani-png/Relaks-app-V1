...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/admin/books', label: 'Books', icon: BookOpen, roles: ['admin', 'super_admin'] },
    { href: '/admin/book-requests', label: 'Book Requests', icon: MessageSquare, roles: ['admin', 'super_admin'] },
