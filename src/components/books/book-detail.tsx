...
import { ArrowLeft, Share2, BookOpen, Calendar, Hash, BookMarked } from 'lucide-react'
  ...
  return (
    <FadeIn className="space-y-6">
      ...
      <Link href="/rent" className="block">
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-2xl p-4 hover:from-purple-100 hover:to-pink-100 dark:hover:from-purple-950/30 dark:hover:to-pink-950/30 transition-colors">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold text-purple-600 dark:text-purple-400">Want to rent this book?</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Join our Book Club - delivery included</p>
            </div>
