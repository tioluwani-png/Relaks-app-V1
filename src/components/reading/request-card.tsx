...
import { ChevronUp, User, Clock, CheckCircle, XCircle, BookOpen } from 'lucide-react'
...
export function RequestCard({ request, onVote, onUnvote }: RequestCardProps) {
  ...
  return (
    <FadeIn className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
      <div className="flex gap-4">
        ...
        <button
          ...
          className={cn(
            'flex flex-col items-center justify-center min-w-[60px] py-2 px-3 rounded-xl transition-colors',
            request.has_voted
        ...
        >
          <ChevronUp className={cn('h-5 w-5', request.has_voted && 'text-purple-600')} />
